...
public interface ManejaRepository extends JpaRepository<ManejaEntity, ManejaPK>{
    ...
    void eliminarManeja(@Param("id_oficina") int id_oficina, @Param("id_gerenteoficina") String id_gerenteoficina);
    ...
    void actualizarManeja(@Param("id_oficina") int id_oficina, @Param("id_gerenteoficina") String id_gerenteoficina, @Param("id_oficina_actualizado") int id_oficina_actualizado, @Param("id_gerenteoficina_actualizado") String id_gerenteoficina_actualizado);
    

    @Modifying
    @Transactional
    @Query(value = "INSERT INTO maneja (id_oficina, id_gerenteoficina) VALUES (:id_oficina, :id_gerenteoficina)", nativeQuery = true)
    void insertarManeja(@Param("id_oficina") int id_oficina, @Param("id_gerenteoficina") String id_gerenteoficina);
