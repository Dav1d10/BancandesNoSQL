...
( NUMERO_DOCUMENTO NUMBER,
    ...
    CONSTRAINT ENUM_TIPOSDOC CHECK (TIPO_DOCUMENTO IN ('NIT', 'CC')),
...
CREATE TABLE CLIENTE (
    ...
    CONSTRAINT CLIENTE_FK FOREIGN KEY (NUMERO_DOCUMENTO) REFERENCES PERSONA(NUMERO_DOCUMENTO));
...
CREATE TABLE GERENTE_GENERAL (
    ...
    CONSTRAINT GERENTE_GENERAL_PK PRIMARY KEY (NUMERO_DOCUMENTO),
    CONSTRAINT GERENTE_GENERAL_FK FOREIGN KEY (NUMERO_DOCUMENTO) REFERENCES PERSONA(NUMERO_DOCUMENTO));
...
CREATE TABLE GERENTE_DE_OFICINA (
    ...
    CONSTRAINT GERENTE_DE_OFICINA_PK PRIMARY KEY (NUMERO_DOCUMENTO),
    CONSTRAINT GERENTE_DE_OFICINA_FK FOREIGN KEY (NUMERO_DOCUMENTO) REFERENCES PERSONA(NUMERO_DOCUMENTO));
...
CREATE TABLE CAJERO (
    ...
    CONSTRAINT CAJERO_PK PRIMARY KEY (NUMERO_DOCUMENTO),
    CONSTRAINT CAJERO_FK FOREIGN KEY (NUMERO_DOCUMENTO) REFERENCES PERSONA(NUMERO_DOCUMENTO));
...
CONSTRAINT ENUM_TIPO CHECK (TIPO IN ('CONSIGNACION', 'RETIRO', 'PEDIR_PRESTAMO', 'PAGAR_PRESTAMO', 'CERRAR_PRESTAMO')),
CONSTRAINT ENUM_PRODUCTO CHECK (PRODUCTO IN ('CUENTA', 'CDT')),
...
( ID_PUNTO_ATENCION NUMBER,
    ...
    TIPO_PUNTO_ATENCION VARCHAR2(25),
    CONSTRAINT ENUM_TIPO_PUNTO_ATENCION CHECK (TIPO_PUNTO_ATENCION IN ('ATENCION PERSONALIZADA', 'CAJERO AUTOMATICO', 'PUNTO_DE_ATENCION_DIGITAL')),
    CONSTRAINT PUNTO_ATENCION_PK_UNIQUE PRIMARY KEY (ID_PUNTO_ATENCION)
);
...
ALTER TABLE TIENE
ADD CONSTRAINT FK_S_CLIENTE_TIENE
    FOREIGN KEY (ID_CLIENTE)
    REFERENCES CLIENTE(ID)
    ENABLE;
