...
( ID NUMBER,
CONSTRAINT GERENTE_GENERAL_PK PRIMARY KEY (ID));


CREATE TABLE GERENTE_DE_OFICINA
( ID NUMBER,
CONSTRAINT GERENTE_DE_OFICINA_PK PRIMARY KEY (ID));
...
CONSTRAINT ENUM_TIPO CHECK (TIPO IN ('CUENTA', 'CDT', 'PRESTAMO')),
CONSTRAINT ENUM_PRODUCTO CHECK (PRODUCTO IN ('CONSIGNACION', 'RETIRO', 'PEDIRPRESTAMO', 'PAGARPRESTAMO', 'CERRARPRESTAMO')),
